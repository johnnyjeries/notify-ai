	...
	if ( defined( 'META_SLIDER_ACTIVE' ) ) {
		...
		echo '<div class="ct_chosen_pro_slider_input_container">';
			echo '<label for="ct_chosen_pro_slider_selection">';
				esc_html_e( 'Choose a slider:', 'chosen-pro' );
			echo '</label> ';
			echo '<select id="ct_chosen_pro_slider_selection" name="ct_chosen_pro_slider_selection">';
				echo '<option value="select">' . esc_html__( "Select a slider", "chosen-pro" ) . '</option>';
				...
				<?php }
			echo '</select>';
			echo '<p><em> ' . esc_html__( "Recommended slider dimensions: 2x1", "chosen-pro" ) . '</em></p>';
		echo '</div>';
		...
		if ( $post->post_type == 'post' ) :
			...
			echo '<div class="ct_chosen_pro_slider_display_container">';
				echo '<p>' . esc_html__( 'Choose where to display the slider:', 'chosen-pro' ) . '</p>';
		...
		if ( array_key_exists( 'ml-slider/ml-slider.php', $plugins ) ) {
			...
			echo '<p class="slider-notice">' . esc_html__( "Featured Sliders require the Meta Slider plugin.", "chosen-pro" );
